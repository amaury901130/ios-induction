[![Build Status](https://img.shields.io/travis/rootstrap/RSDemoProject/master.svg)](https://travis-ci.org/rootstrap/RSDemoProject)
...
- [**feature/observe_root_vc**](https://github.com/rootstrap/RSDemoProject/tree/feature/observe_root_vc): Detecting when **rootViewController** gets loaded.
- [**feature/util_gradients**](https://github.com/rootstrap/RSDemoProject/tree/feature/util_gradients): Helper methods to easily add **color gradients**.
- [**feature/paginated_collections**](https://github.com/rootstrap/RSDemoProject/tree/feature/paginated_collections): Adds **paginated** subclasses of **UITableView** and **UICollectionView**.
- [**feature/mvvm+rxswift**](https://github.com/rootstrap/RSDemoProject/tree/feature/mvvm%2Brxswift) in case you want to work with **RxSwift** and **MVVM**.
...
**iOS Base** is maintained by [Rootstrap](http://www.rootstrap.com) with the help of our [contributors](https://github.com/rootstrap/RSDemoProject/contributors).
