...
class SessionManager: NSObject {
  ...
  static var currentSession: Session? {
    get {
      if
        let data = UserDefaults.standard.data(forKey: "RSDemoProject-session"),
    ...
    set {
      ...
      UserDefaults.standard.set(session, forKey: "RSDemoProject-session")
    }
  }
  
  class func deleteSession() {
    UserDefaults.standard.removeObject(forKey: "RSDemoProject-session")
  }
